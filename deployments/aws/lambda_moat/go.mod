...
require (
	...
	github.com/safetorun/PromptDefender/moat v0.0.0-20231017114830-c0695821fa78
	github.com/safetorun/PromptDefender/pii_aws v0.0.0-20231017114830-c0695821fa78
)

require (
	github.com/aws/aws-sdk-go v1.45.26 // indirect
	github.com/jmespath/go-jmespath v0.4.0 // indirect
	github.com/safetorun/PromptDefender/pii v0.0.0-20231017114830-c0695821fa78 // indirect
)
