...
type ClientInterface interface {
	...
	// WallPromptWithBody request with any body
	WallPromptWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	WallPrompt(ctx context.Context, body WallPromptJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
}
...
func (c *Client) WallPromptWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewWallPromptRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) WallPrompt(ctx context.Context, body WallPromptJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewWallPromptRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewBuildShieldRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/moat")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewWallPromptRequest calls the generic WallPrompt builder with application/json body
func NewWallPromptRequest(server string, body WallPromptJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewWallPromptRequestWithBody(server, "application/json", bodyReader)
}

// NewWallPromptRequestWithBody generates requests for WallPrompt with any type of body
func NewWallPromptRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// WallPromptWithBodyWithResponse request with any body
	WallPromptWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*WallPromptResponse, error)

	WallPromptWithResponse(ctx context.Context, body WallPromptJSONRequestBody, reqEditors ...RequestEditorFn) (*WallPromptResponse, error)
}
...
type WallPromptResponse struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r WallPromptResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r WallPromptResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// WallPromptWithBodyWithResponse request with arbitrary body returning *WallPromptResponse
func (c *ClientWithResponses) WallPromptWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*WallPromptResponse, error) {
	rsp, err := c.WallPromptWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseWallPromptResponse(rsp)
}

func (c *ClientWithResponses) WallPromptWithResponse(ctx context.Context, body WallPromptJSONRequestBody, reqEditors ...RequestEditorFn) (*WallPromptResponse, error) {
	rsp, err := c.WallPrompt(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseWallPromptResponse(rsp)
...
// ParseWallPromptResponse parses an HTTP response from a WallPromptWithResponse call
func ParseWallPromptResponse(rsp *http.Response) (*WallPromptResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
